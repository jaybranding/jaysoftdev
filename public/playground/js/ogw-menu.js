  ...
  $.getJSON(menuAPI, {
    ...
    $.each(data, function (i, item) {
      ...
      mainmenum =
        ...
        ">" +
        data[i].navigation.title +
        '<span class="icon icoright"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 24 20"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/></svg></span></itemm>' +
        "<subitemms link=" +
        [i] +
        ">";
      ...
      $.each(data[i].navigation.item, function (j, item) {
        ...
        popupm =
          ...
          ariacontrols +
          ">" +
          '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16" style="padding-top: 6px;"><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/></svg>' +
        ...
        $.each(data[i].navigation.item[j].menu, function (x, item) {
          ...
          popupm =
            popupm +
            `<li><a href="${pathURL}">
            <svg style="padding-top: 8px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 24 20"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"></path></svg>
